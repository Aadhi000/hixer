...
CLONE_SESSIONS = (environ.get('CLONE_SESSIONS'))

CLONED_SESSIONS = (environ.get('CLONED_SESSIONS'))
...
SPELL_IMG = environ.get("SPELL_IMG", "https://telegra.ph/file/4f2534044ebb1a80fcc5a.jpg")
...
SHORTLINK_API = environ.get('SHORTLINK_API', '84ce396ac3db78a7427f925f17dbd224b69e55cb')
...
MSG_ALRT = environ.get('MSG_ALRT', 'SUPPORT PLEASE')
